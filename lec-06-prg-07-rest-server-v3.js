...
app
  .route("/membership_api/:member_id")
  .get((req, res) => {
    res.json(myManager.read(req.params.member_id));
  })
  .post((req, res) => {
    res.json(myManager.create(req.params.member_id, req.body[req.params.member_id]));
  })
  .put((req, res) => {
    res.json(myManager.update(req.params.member_id, req.body[req.params.member_id]));
  })
  .delete((req, res) => {
